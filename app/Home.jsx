...
import { useNavigation } from '@react-navigation/native'; //o router é baseado no sistema de pastas, enquanto o useNavigation é um pouco mais complexo e navaga pelos arquivos 

//pu

export default function Page() {
  const navigation = useNavigation();
  const { contador, adicionarItem } = useContext(AppContext); //contador de itens do carrinho

  const handleCompra = (item) => { //arrow function para quando o usuário clicar, um item ser adicionado 
    adicionarItem(item); 
  };
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.counterContainer}>
        ...
        <Pressable onPress={() => navigation.navigate('Carrinho')} style={styles.link}> {/*arrow function on press com navigation para mudar de página */}
          <Image
